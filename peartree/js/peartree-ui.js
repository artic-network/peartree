  ...
  return `
    <div class="pt-palette-section">
      ...
      <div id="tip-label-controls" class="pt-sub-controls" style="display:none">
        ...
        <div class="pt-palette-row" id="label-palette-row" style="display:none" title="Colour palette for annotation-based tip label colouring"><span class="pt-palette-label">Palette</span><select class="pt-palette-select" id="label-palette-select"></select></div>
  ...
  return `
    <div class="pt-palette-section">
      ...
      <div id="tip-label-shape-detail" class="pt-detail pt-sub-controls">
        ...
        <div class="pt-palette-row" id="tip-label-shape-palette-row" style="display:none" title="Colour palette for annotation-based label shape colouring"><span class="pt-palette-label">Palette</span><select class="pt-palette-select" id="tip-label-shape-palette-select"></select></div>
      ...
      <div id="tip-label-shape-${n}-section" class="pt-detail">
        ...
        <div id="tip-label-shape-${n}-detail" class="pt-detail pt-sub-controls">
          ...
          <div class="pt-palette-row" id="tip-label-shape-${n}-palette-row" style="display:none" title="Colour palette for shape ${n}"><span class="pt-palette-label">Palette</span><select class="pt-palette-select" id="tip-label-shape-${n}-palette-select"></select></div>
        </div>
      </div>`).join('')}
    </div>`;
}
  ...
  return `
    <div class="pt-palette-section">
      ...
      <div id="tip-shape-detail" class="pt-detail pt-sub-controls">
        ...
        <div class="pt-palette-row" id="tip-palette-row" style="display:none" title="Colour palette for annotation-based tip circle colouring"><span class="pt-palette-label">Palette</span><select class="pt-palette-select" id="tip-palette-select"></select></div>
      </div>
    </div>`;
}
  ...
  return `
    <div class="pt-palette-section">
      ...
      <div id="node-shape-detail" class="pt-detail pt-sub-controls">
        ...
        <div class="pt-palette-row" id="node-palette-row" style="display:none" title="Colour palette for annotation-based node circle colouring"><span class="pt-palette-label">Palette</span><select class="pt-palette-select" id="node-palette-select"></select></div>
      </div>
    </div>`;
}
    ...
    <div class="pt-palette-section" id="node-bars-section">
      ...
      <div id="node-bars-controls" style="display:none">
        ...
        <div id="node-bars-detail" class="pt-detail pt-sub-controls">
          ...
          <div class="pt-palette-row" title="Draw a vertical line at the mean or median of each bar"><span class="pt-palette-label">Line <i class="bi bi-vr form-label-sm"></i></span><select class="pt-palette-select" id="node-bars-median"><option value="none">(none)</option><option value="mean">Mean</option><option value="median">Median</option></select></div>
...
function _sectionCladeHighlights() {
  return `
    <div class="pt-palette-section" id="clade-highlights-section">
      ...
      <div class="pt-palette-row" title="Shape of the left edge of clade highlight boxes"><span class="pt-palette-label">Left edge <i class="bi bi-arrow-left-square form-label-sm"></i></span><select class="pt-palette-select" id="clade-highlight-left-edge"><option value="hard">Rectangle</option><option value="outline">Outline subtree</option></select></div>
