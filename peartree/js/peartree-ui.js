...
function _sectionRtt() {
  return `
    <div class="pt-palette-section" id="rtt-section">
      ...
      <div class="pt-palette-row pt-rtt-adv-row" title="Background colour of the statistics summary box"><span class="pt-palette-label">Background <i class="bi bi-palette form-label-sm"></i></span><input type="color" class="pt-palette-color" id="rtt-stats-bg-color" value="#081c22" /></div>
      <div class="pt-palette-row pt-rtt-adv-row" title="Text colour of the statistics summary box"><span class="pt-palette-label">Text <i class="bi bi-palette form-label-sm"></i></span><input type="color" class="pt-palette-color" id="rtt-stats-text-color" value="#f2f1e6" /></div>
      <div class="pt-palette-row pt-rtt-adv-row" title="Font size of the statistics summary box"><span class="pt-palette-label">Size <i class="bi bi-fonts form-label-sm"></i></span><input type="range" class="form-range" id="rtt-stats-font-size-slider" min="6" max="32" value="11" /><span class="pt-val" id="rtt-stats-font-size-value">11</span></div>
