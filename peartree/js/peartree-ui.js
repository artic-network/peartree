  ...
  return `
    <div class="pt-palette-section">
      ...
      <div id="tip-label-controls" class="pt-sub-controls" style="display:none">
        ...
        <div class="pt-palette-row"><span class="pt-palette-label">Alignment <i class="bi bi-text-left form-label-sm"></i></span><select class="pt-palette-select" id="tip-label-align"><option value="off">Off</option><option value="aligned">Aligned</option><option value="dots">Aligned + dots</option><option value="dashed">Aligned + dashed</option><option value="solid">Aligned + solid</option></select></div>
        ...
        <div class="pt-palette-row"><span class="pt-palette-label">Typeface <i class="bi bi-type form-label-sm"></i></span><select class="pt-palette-select" id="typeface-select">${_TYPEFACES}</select></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Style <i class="bi bi-type-italic form-label-sm"></i></span><select class="pt-palette-select" id="typeface-style-select"><option value="">Theme</option></select></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Colour <i class="bi bi-palette form-label-sm"></i></span><input type="color" class="pt-palette-color" id="label-color" value="#f7eeca" /></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Colour by <i class="bi bi-palette2 form-label-sm"></i></span><select class="pt-palette-select" id="label-colour-by" disabled><option value="user_colour">user colour</option></select></div>
        ...
        <div class="pt-palette-row"><span class="pt-palette-label">Spacing <i class="bi bi-arrow-bar-right form-label-sm"></i></span><input type="range" class="form-range" id="tip-label-spacing-slider" min="0" max="100" step="1" value="3" /><span class="pt-val" id="tip-label-spacing-value">3</span></div>
      </div>
    </div>`;
}
  ...
  return `
    <div class="pt-palette-section">
      ...
      <div id="tip-label-shape-detail" class="pt-detail pt-sub-controls">
        <div class="pt-palette-row"><span class="pt-palette-label">Colour <i class="bi bi-palette form-label-sm"></i></span><input type="color" class="pt-palette-color" id="tip-label-shape-color" value="#aaaaaa" /></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Colour by <i class="bi bi-palette2 form-label-sm"></i></span><select class="pt-palette-select" id="tip-label-shape-colour-by" disabled><option value="user_colour">user colour</option></select></div>
        ...
        <div class="pt-palette-row"><span class="pt-palette-label">Size <i class="bi bi-box-arrow-up-right form-label-sm"></i></span><input type="range" class="form-range" id="tip-label-shape-size-slider" min="1" max="100" step="1" value="50" /><span class="pt-val" id="tip-label-shape-size-value">50</span></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Pad left <i class="bi bi-arrow-bar-right form-label-sm"></i></span><input type="range" class="form-range" id="tip-label-shape-margin-left-slider" min="0" max="100" value="2" /><span class="pt-val" id="tip-label-shape-margin-left-value">2</span></div>
        <div class="pt-palette-row" id="tip-label-shape-spacing-row" style="display:none"><span class="pt-palette-label">Spacing <i class="bi bi-arrows form-label-sm"></i></span><input type="range" class="form-range" id="tip-label-shape-spacing-slider" min="0" max="50" value="3" /><span class="pt-val" id="tip-label-shape-spacing-value">3</span></div>
      </div>
      ...
      <div id="tip-label-shape-${n}-section" class="pt-detail">
        ...
        <div id="tip-label-shape-${n}-detail" class="pt-detail pt-sub-controls">
          <div class="pt-palette-row"><span class="pt-palette-label">Colour by <i class="bi bi-palette2 form-label-sm"></i></span><select class="pt-palette-select" id="tip-label-shape-${n}-colour-by" disabled><option value="user_colour">user colour</option></select></div>
  ...
  return `
    <div class="pt-palette-section">
      ...
      <div id="tip-shape-detail" class="pt-detail pt-sub-controls">
        ...
        <div class="pt-palette-row"><span class="pt-palette-label">Halo <i class="bi bi-arrow-up-right-circle form-label-sm"></i></span><input type="range" class="form-range" id="tip-halo-slider" min="0" max="8" value="2" /><span class="pt-val" id="tip-halo-value">2</span></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Halo col. <i class="bi bi-palette form-label-sm"></i></span><input type="color" class="pt-palette-color" id="tip-shape-bg-color" value="#02292e" /></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Colour by <i class="bi bi-palette2 form-label-sm"></i></span><select class="pt-palette-select" id="tip-colour-by" disabled><option value="user_colour">user colour</option></select></div>
...
function _sectionNodeShapes() {
  return `
    <div class="pt-palette-section">
      ...
      <div class="pt-palette-row"><span class="pt-palette-label">Size <i class="bi bi-arrow-up-right-circle-fill form-label-sm"></i></span><input type="range" class="form-range" id="node-size-slider" min="0" max="24" value="0" /><span class="pt-val" id="node-size-value">0</span></div>
      <div id="node-shape-detail" class="pt-detail pt-sub-controls">
        <div class="pt-palette-row"><span class="pt-palette-label">Colour <i class="bi bi-palette form-label-sm"></i></span><input type="color" class="pt-palette-color" id="node-shape-color" value="#888888" /></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Halo <i class="bi bi-arrow-up-right-circle form-label-sm"></i></span><input type="range" class="form-range" id="node-halo-slider" min="0" max="8" value="2" /><span class="pt-val" id="node-halo-value">2</span></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Halo col. <i class="bi bi-palette form-label-sm"></i></span><input type="color" class="pt-palette-color" id="node-shape-bg-color" value="#02292e" /></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Colour by <i class="bi bi-palette2 form-label-sm"></i></span><select class="pt-palette-select" id="node-colour-by" disabled><option value="user_colour">user colour</option></select></div>
  ...
  return `
    <div class="pt-palette-section">
      ...
      <div id="node-label-detail" class="pt-detail pt-sub-controls">
        <div class="pt-palette-row" id="node-label-dp-row" style="display:none"><span class="pt-palette-label">d.p. <i class="bi bi-three-dots form-label-sm"></i></span><select class="pt-palette-select" id="node-label-decimal-places"><option value="">Auto</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option></select></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Position <i class="bi bi-diagram-2-fill form-label-sm" style="display:inline-block;transform:rotate(90deg)"></i></span><select class="pt-palette-select" id="node-label-position"><option value="right">Right</option><option value="above-left">Above left</option><option value="below-left">Below left</option></select></div>
        ...
        <div class="pt-palette-row"><span class="pt-palette-label">Typeface <i class="bi bi-type form-label-sm"></i></span><select class="pt-palette-select" id="node-label-typeface-select">${_TYPEFACES}</select></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Style <i class="bi bi-type-italic form-label-sm"></i></span><select class="pt-palette-select" id="node-label-typeface-style-select"><option value="">Theme</option></select></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Colour <i class="bi bi-palette form-label-sm"></i></span><input type="color" class="pt-palette-color" id="node-label-color" value="#aaaaaa" /></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Spacing <i class="bi bi-arrow-bar-right form-label-sm"></i></span><input type="range" class="form-range" id="node-label-spacing-slider" min="0" max="20" step="1" value="4" /><span class="pt-val" id="node-label-spacing-value">4</span></div>
      </div>
    </div>`;
}
...
function _sectionCladeHighlights() {
  return `
    <div class="pt-palette-section" id="clade-highlights-section">
      ...
      <div class="pt-palette-row"><span class="pt-palette-label">Colour by <i class="bi bi-palette2 form-label-sm"></i></span><select class="pt-palette-select" id="clade-highlight-colour-by"><option value="user_colour">User colour</option></select></div>
      <div class="pt-palette-row"><span class="pt-palette-label">Left edge <i class="bi bi-arrow-left-square form-label-sm"></i></span><select class="pt-palette-select" id="clade-highlight-left-edge"><option value="hard">Rectangle</option><option value="outline">Outline subtree</option></select></div>
...
function _sectionCollapsedClades() {
  return `
    <div class="pt-palette-section" id="collapsed-clades-section">
      ...
      <div class="pt-palette-row"><span class="pt-palette-label">Style <i class="bi bi-type-italic form-label-sm"></i></span><select class="pt-palette-select" id="collapsed-clade-typeface-style-select"><option value="">Theme</option></select></div>
    </div>`;
}
  ...
  return `
    <div class="pt-palette-section">
      ...
      <div id="legend-detail" class="pt-detail pt-sub-controls">
        <div class="pt-palette-row"><span class="pt-palette-label">Span <i class="bi bi-arrows-expand form-label-sm"></i></span><input type="range" class="form-range" id="legend-height-pct-slider" min="10" max="100" step="5" value="100" /><span class="pt-val" id="legend-height-pct-value">100%</span></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Colour <i class="bi bi-palette form-label-sm"></i></span><input type="color" class="pt-palette-color" id="legend-text-color" value="#f7eeca" /></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Size <i class="bi bi-fonts form-label-sm"></i></span><input type="range" class="form-range" id="legend-font-size-slider" min="6" max="48" value="11" /><span class="pt-val" id="legend-font-size-value">11</span></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Typeface <i class="bi bi-type form-label-sm"></i></span><select class="pt-palette-select" id="legend-font-family-select">${_TYPEFACES}</select></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Style <i class="bi bi-type-italic form-label-sm"></i></span><select class="pt-palette-select" id="legend-typeface-style-select"><option value="">Theme</option></select></div>
      </div>
      <div id="legend2-section" class="pt-detail">
        ...
        <div id="legend2-detail" class="pt-detail pt-sub-controls">
          <div class="pt-palette-row"><span class="pt-palette-label">Position <i class="bi bi-box-arrow-down-right form-label-sm"></i></span><select class="pt-palette-select" id="legend2-show"><option value="right">Right</option><option value="below">Below</option></select></div>
          <div class="pt-palette-row"><span class="pt-palette-label">Span <i class="bi bi-arrows-expand form-label-sm"></i></span><input type="range" class="form-range" id="legend2-height-pct-slider" min="10" max="100" step="5" value="50" /><span class="pt-val" id="legend2-height-pct-value">50%</span></div>
        </div>
      </div>
      <div id="legend3-section" class="pt-detail">
        ...
        <div id="legend3-detail" class="pt-detail pt-sub-controls">
          <div class="pt-palette-row"><span class="pt-palette-label">Position <i class="bi bi-box-arrow-down-right form-label-sm"></i></span><select class="pt-palette-select" id="legend3-show"><option value="right">Right</option><option value="below">Below</option></select></div>
          <div class="pt-palette-row"><span class="pt-palette-label">Span <i class="bi bi-arrows-expand form-label-sm"></i></span><input type="range" class="form-range" id="legend3-height-pct-slider" min="10" max="100" step="5" value="50" /><span class="pt-val" id="legend3-height-pct-value">50%</span></div>
        </div>
      </div>
      <div id="legend4-section" class="pt-detail">
        ...
        <div id="legend4-detail" class="pt-detail pt-sub-controls">
          <div class="pt-palette-row"><span class="pt-palette-label">Position <i class="bi bi-box-arrow-down-right form-label-sm"></i></span><select class="pt-palette-select" id="legend4-show"><option value="right">Right</option><option value="below">Below</option></select></div>
          <div class="pt-palette-row"><span class="pt-palette-label">Span <i class="bi bi-arrows-expand form-label-sm"></i></span><input type="range" class="form-range" id="legend4-height-pct-slider" min="10" max="100" step="5" value="50" /><span class="pt-val" id="legend4-height-pct-value">50%</span></div>
        </div>
  ...
  return `
    <div class="pt-palette-section">
      ...
      <div id="axis-detail" class="pt-detail pt-sub-controls">
        ...
        <div class="pt-palette-row"><span class="pt-palette-label">Size <i class="bi bi-fonts form-label-sm"></i></span><input type="range" class="form-range" id="axis-font-size-slider" min="6" max="48" value="9" /><span class="pt-val" id="axis-font-size-value">9</span></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Typeface <i class="bi bi-type form-label-sm"></i></span><select class="pt-palette-select" id="axis-font-family-select">${_TYPEFACES}</select></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Style <i class="bi bi-type-italic form-label-sm"></i></span><select class="pt-palette-select" id="axis-typeface-style-select"><option value="">Theme</option></select></div>
        <div class="pt-palette-row"><span class="pt-palette-label">Line <i class="bi bi-border-width form-label-sm"></i></span><input type="range" class="form-range" id="axis-line-width-slider" min="0.5" max="4" step="0.5" value="1" /><span class="pt-val" id="axis-line-width-value">1</span></div>
        <div class="pt-palette-row" id="axis-date-format-row" style="display:none"><span class="pt-palette-label">Format <i class="bi bi-calendar-check form-label-sm"></i></span><select class="pt-palette-select" id="axis-date-format"><option value="yyyy-MM-dd">1977-05-04</option><option value="yyyy-MMM-dd">1977-May-04</option><option value="dd MMM yyyy">04 May 1977</option><option value="dd MMMM yyyy">04 May 1977 (long month)</option><option value="MMM dd, yyyy">May 04, 1977</option><option value="MMMM dd, yyyy">May 04, 1977 (long month)</option><option value="MMM-dd-yyyy">May-04-1977</option></select></div>
        ...
        <div class="pt-palette-row" id="axis-minor-interval-row" style="display:none"><span class="pt-palette-label">Minor ticks <i class="bi bi-text-left form-label-sm" style="display:inline-block;transform:rotate(90deg)"></i></span><select class="pt-palette-select" id="axis-minor-interval"><option value="off">Off</option></select></div>
        ...
        <div class="pt-palette-row" id="axis-minor-label-row" style="display:none"><span class="pt-palette-label">Minor labels <i class="bi bi-tag form-label-sm"></i></span><select class="pt-palette-select" id="axis-minor-label"><option value="component">Component</option><option value="partial">Partial</option><option value="full">Full</option><option value="off">Off</option></select></div>
      </div>
    </div>`;
}
...
function _sectionRtt() {
  return `
    <div class="pt-palette-section" id="rtt-section">
      ...
      <div class="pt-palette-row"><span class="pt-palette-label">Reg. line <i class="bi bi-border-style form-label-sm"></i></span><select class="pt-palette-select" id="rtt-regression-style"><option value="solid">Solid</option><option value="bigdash">Big dash</option><option value="dash">Dash</option><option value="dots">Dots</option></select></div>
      <div class="pt-palette-row"><span class="pt-palette-label">Reg. colour <i class="bi bi-palette form-label-sm"></i></span><input type="color" class="pt-palette-color" id="rtt-regression-color" value="#f2f1e6" /></div>
      <div class="pt-palette-row"><span class="pt-palette-label">Reg. width <i class="bi bi-border-width form-label-sm"></i></span><input type="range" class="form-range" id="rtt-regression-width-slider" min="0.5" max="6" step="0.5" value="1.5" /><span class="pt-val" id="rtt-regression-width-value">1.5</span></div>
      <div class="pt-palette-subhead">Statistics box</div>
      <div class="pt-palette-row pt-rtt-adv-row"><span class="pt-palette-label">Box bg <i class="bi bi-palette form-label-sm"></i></span><input type="color" class="pt-palette-color" id="rtt-stats-bg-color" value="#081c22" /></div>
      <div class="pt-palette-row pt-rtt-adv-row"><span class="pt-palette-label">Box text <i class="bi bi-palette form-label-sm"></i></span><input type="color" class="pt-palette-color" id="rtt-stats-text-color" value="#f2f1e6" /></div>
      <div class="pt-palette-row pt-rtt-adv-row"><span class="pt-palette-label">Box font <i class="bi bi-fonts form-label-sm"></i></span><input type="range" class="form-range" id="rtt-stats-font-size-slider" min="6" max="32" value="11" /><span class="pt-val" id="rtt-stats-font-size-value">11</span></div>
      <div class="pt-palette-subhead">Axes</div>
      <div class="pt-palette-row"><span class="pt-palette-label">Axis colour <i class="bi bi-palette form-label-sm"></i></span><input type="color" class="pt-palette-color" id="rtt-axis-color" value="#f2f1e6" /></div>
      ...
      <div class="pt-palette-row"><span class="pt-palette-label">Axis line <i class="bi bi-border-width form-label-sm"></i></span><input type="range" class="form-range" id="rtt-axis-line-width-slider" min="0.5" max="4" step="0.5" value="1" /><span class="pt-val" id="rtt-axis-line-width-value">1</span></div>
      <div class="pt-palette-row"><span class="pt-palette-label">Typeface <i class="bi bi-type form-label-sm"></i></span><select class="pt-palette-select" id="rtt-axis-font-family-select">${_TYPEFACES}</select></div>
      <div class="pt-palette-row"><span class="pt-palette-label">Style <i class="bi bi-type-italic form-label-sm"></i></span><select class="pt-palette-select" id="rtt-axis-typeface-style-select"><option value="">Theme</option></select></div>
      <div class="pt-palette-row" id="rtt-date-format-row" style="display:none"><span class="pt-palette-label">Format <i class="bi bi-calendar-check form-label-sm"></i></span><select class="pt-palette-select" id="rtt-date-format"><option value="yyyy-MM-dd">1977-05-04</option><option value="yyyy-MMM-dd">1977-May-04</option><option value="dd MMM yyyy">04 May 1977</option><option value="dd MMMM yyyy">04 May 1977 (long month)</option><option value="MMM dd, yyyy">May 04, 1977</option><option value="MMMM dd, yyyy">May 04, 1977 (long month)</option><option value="MMM-dd-yyyy">May-04-1977</option></select></div>
      ...
      <div class="pt-palette-row" id="rtt-minor-interval-row" style="display:none"><span class="pt-palette-label">Minor ticks <i class="bi bi-text-left form-label-sm" style="display:inline-block;transform:rotate(90deg)"></i></span><select class="pt-palette-select" id="rtt-minor-interval"><option value="off">Off</option></select></div>
      ...
      <div class="pt-palette-row" id="rtt-minor-label-row" style="display:none"><span class="pt-palette-label">Minor labels <i class="bi bi-tag form-label-sm"></i></span><select class="pt-palette-select" id="rtt-minor-label"><option value="component">Component</option><option value="partial">Partial</option><option value="full">Full</option><option value="off">Off</option></select></div>
    </div>`;
}
