...
|---|---|---|
| `axisColor` | CSS colour string | `#4b4b49` |
...
| `branchColor` | CSS colour string | `#333231` |
| `branchColourBy` | string or null | `user_colour` |
| `branchLabelAnnotation` | string | `n/a` |
| `branchLabelColor` | CSS colour string | `#aaaaaa` |
| `branchLabelColourBy` | string or null | `user_colour` |
...
| `branchShape2Color` | CSS colour string | `#aaaaaa` |
| `branchShape3Color` | CSS colour string | `#aaaaaa` |
| `branchShape4Color` | CSS colour string | `#aaaaaa` |
| `branchShapeAlign` | 'left' \| 'center' \| 'right' | `center` |
| `branchShapeColor` | CSS colour string | `#aaaaaa` |
| `branchShapeColourBy` | string or null | `user_colour` |
| `branchShapeCountBy` | string or null | `""` |
| `branchShapeHalo` | number or numeric string | `0` |
| `branchShapeHaloColor` | CSS colour string | `#02292e` |
| `branchShapeHeightPct` | number (0..100, step 1) | `50` |
| `branchShapeSpacing` | number or numeric string | `3` |
| `branchShapesFilter` | string or null | `null` |
...
| `canvasBgColor` | CSS colour string | `#ebe8e2` |
| `cladeHighlightColour` | CSS colour string | `#ffaa00` |
...
| `tipLabelColor` | CSS colour string | `#4b4b49` |
...
| `legendTextColor` | CSS colour string | `#4b4b49` |
| `legendTypefaceKey` | string | `n/a` |
| `legendTypefaceStyle` | string | `n/a` |
| `labelColourBy` | string or null | `user_colour` |
| `nodeBarsColor` | CSS colour string | `#333231` |
...
| `nodeHoverFillColor` | CSS colour string | `#f5a700` |
...
| `nodeHoverStrokeColor` | CSS colour string | `#f5a700` |
| `nodeHoverStrokeOpacity` | number or numeric string (typically 0..1) | `0` |
| `nodeHoverStrokeWidth` | number or numeric string | `0.5` |
| `nodeColourBy` | string or null | `user_colour` |
| `nodeLabelAnnotation` | string | `n/a` |
| `nodeLabelColor` | CSS colour string | `#aaaaaa` |
| `nodeLabelColourBy` | string or null | `user_colour` |
...
| `nodeShapeBgColor` | CSS colour string | `#ebe8e2` |
| `nodeShapeColor` | CSS colour string | `#4b4b49` |
...
| `paintColour` | CSS colour string | `#ff8800` |
...
| `rttAxisColor` | CSS colour string | `#4b4b49` |
...
| `rttRegressionColor` | CSS colour string | `#807e7c` |
| `rttRegressionStyle` | 'dash' \| 'bigdash' \| 'solid' | `bigdash` |
| `rttRegressionWidth` | number or numeric string | `1.5` |
| `rttResidBandColor` | CSS colour string | `#807e7c` |
| `rttResidBandFillColor` | CSS colour string | `#807e7c` |
...
| `selectedNodeStrokeColor` | CSS colour string | `#5c0700` |
...
| `selectedTipFillColor` | CSS colour string | `#004d65` |
...
| `selectedTipStrokeColor` | CSS colour string | `#00364a` |
...
| `tipHoverFillColor` | CSS colour string | `#f5a700` |
...
| `tipHoverStrokeColor` | CSS colour string | `#f5a700` |
...
| `tipLabelShapeColor` | CSS colour string | `#aaaaaa` |
| `tipLabelShapeColourBy` | string or null | `user_colour` |
...
| `tipShapeBgColor` | CSS colour string | `#4b4b49` |
| `tipShapeColor` | CSS colour string | `#ebe8e2` |
| `tipColourBy` | string or null | `user_colour` |
